...
class ScenariosControllerTest < ActionController::TestCase
  ...
  test "should create scenario" do
    assert_difference('Scenario.count') do
      post :create, scenario: { finish_node_id: @scenario.finish_node_id, start_node_id: @scenario.start_node_id, title: @scenario.title }
    end
  ...
  test "should update scenario" do
    patch :update, id: @scenario, scenario: { finish_node_id: @scenario.finish_node_id, start_node_id: @scenario.start_node_id, title: @scenario.title }
    assert_redirected_to scenario_path(assigns(:scenario))
  end
